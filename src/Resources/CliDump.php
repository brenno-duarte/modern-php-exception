...
class CliDump
{
    ...
    private function output(string $data)
    {
        ...
        if ($this->isCli) {
            ...
            echo "<code style='word-wrap:break-word;display:block;margin-bottom:20px'><small>at: {$file}</small><br />{$data}</code>";
        }
    }
